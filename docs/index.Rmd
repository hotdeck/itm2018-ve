...
subtitle: "Discussion with Two Case Studies"
author: "Liming Wang"
...
- Competing data generation models may give different pictures of the relation between the predictor and response variables;
- Changing landscape of data availability
   - Curse of dimensionality
   - Easy to detect a significant correlation with large sample size
   - Increasingly models involving data of the population instead of a sample
- More open source ML software/packages and powerful/cheaper computers/servers

---
<!-- background-image: url("resources/Olson2018.png") -->
background-image: url("resources/machine-learning-cheet-sheet.png")
background-size: 100%
class: center, bottom

Source: SAS, available at https://blogs.sas.com/content/subconsciousmusings/2017/04/12/machine-learning-algorithm-use/
---
...
**Imputation Results (2)**: Comparing regression results without and with multiple imputation
