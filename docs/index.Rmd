...
Two cultures of developing models:
...
- Machine learning ("the algorithmic modeling"): With no assumption of data generation process, use computer algorithms for pattern recognition and data-driven predictions-making

![Breiman2003](resources/Breiman2003.png)
